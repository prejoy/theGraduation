...
#define FLASH_SIZE 33554432 // = 32*1024*1024
//4Kbytes为一个Sector
//16个扇区为1个Block
//W25Q256
...
//  i = W25QXX_Init();
//  printf("\r\nW25QInit:%d\r\n",i);
//  uint8_t Spi_Write_Buffer[]={"prejoy"};
//  uint8_t Spi_Read_Buffer[]={"qqqqqq"};
//  uint32_t FLASH_SIZE=32*1024*1024;
//  W25QXX_Write((uint8_t*)Spi_Write_Buffer,FLASH_SIZE-100,6);
//  HAL_Delay(500);
//  W25QXX_Read(Spi_Read_Buffer,FLASH_SIZE-100,6);
//  printf("%s\r\n",Spi_Read_Buffer);
