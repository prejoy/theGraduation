...
#define configMAX_PRIORITIES					(32)                    //可使用的最大优先级，32位是根据 计算前导零指令来决定的
#define configMINIMAL_STACK_SIZE				((unsigned short)130)   //空闲任务使用的堆栈大小，保存任务的运行环境
...
#define configTOTAL_HEAP_SIZE					((size_t)(60*1024))     //系统所有总的堆大小   给FreeRTOS分配了50K的内存
...
#define configTIMER_TASK_PRIORITY		(configMAX_PRIORITIES-1)        //软件定时器优先级   最大的优先级
